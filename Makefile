...
#-----------------------------------------------------------------------------
vendor_remove_files := app/Gallery2.apk third-app/FileExplorer.apk third-app/MiMarket.apk
...
#-----------------------------------------------------------------------------
vendor_saved_apps := Bluetooth BluetoothExt Camera2 Stk Nfc Tag MiSettings FM2 FMRecord
...
#-----------------------------------------------------------------------------
baidu_modify_apps := Settings TelephonyProvider TeleService Keyguard SystemUI
...
override_property += \
    ...
    ro.baidu.romerinfo=weibo.com/pochanL \
